...
public class ShowShoppingCartCommand implements Command {
	...
	public ShowShoppingCartCommand(RemoteOnlineStore remoteProductStub, String userID ) {
	...
	public void execute() {
		try {
			...
			List<Product> products = this.remoteProductStub.showShoppingcart(this.userID);
